...
const NotificationsHeader = ({ notificationCount, onNotificationClick }) => {
  ...
  return (
    <div className="flex justify-between items-center py-6 px-8 bg-gradient-to-r from-blue-800 via-blue-600 to-indigo-600 rounded-xl shadow-xl mb-6">
      <h2 className="text-3xl font-semibold text-white bg-clip-text text-transparent">
        {getTitle()}
      </h2>
      <div className="flex items-center gap-6">
        {isAdmin ? (
          <>
            <Link
              to="/admin/companies"
              className={`relative cursor-pointer transition-all duration-200 ease-in-out hover:scale-105 p-4 rounded-full shadow-md ${getActiveClass(
                "/admin/companies"
              )}`}
        ...
        <button
          ...
          className="relative cursor-pointer transition-all duration-200 ease-in-out hover:scale-105 p-4 rounded-full shadow-md bg-red-500 text-white hover:bg-red-600"
          title="Logout"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
